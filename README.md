...
- `playbook-ztp-setup`: Setup all software on ZTP servers
- `playbook-ztp-init`: Init local repository
- `playbook-ztp-conf-generate`: Create configuration for ZTP and store them locally
- `playbook-ztp-push-data`: Push configuration generated by `playbook-ztp-conf-generate` to remote ztp servers
- `playbook-ztp-complete`: Execute all actions in one playbook
